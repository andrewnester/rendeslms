...
class Step extends \Rendes\Modules\Courses\Entities\Step implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setTincan($tincan);
    }

    public function getTincan()
    {
        $this->__load();
        return parent::getTincan();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'description', 'order', 'created', 'updated', 'course', 'lectures', 'quizzes', 'tincan');
    }
