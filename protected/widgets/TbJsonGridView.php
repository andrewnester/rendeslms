...
Yii::import('application.widgets.TbGridView');
Yii::import('application.widgets.TbJsonDataColumn');
...
class TbJsonGridView extends TbGridView
{
	 ...
	 */
	public $pager = array('class' => 'application.widgets.TbJsonPager');
	...
	protected function initColumns()
	{
		foreach ($this->columns as $i => $column) {
			if (is_array($column) && !isset($column['class'])) {
				$this->columns[$i]['class'] = 'application.widgets.TbJsonDataColumn';
			}
		}
